...
const About = () => (
  <div>
    ...
    <section className="relative bg-background py-24 md:py-32 overflow-hidden">
      <div className="absolute top-0 left-0 w-1/4 h-full bg-primary hidden lg:block" />
      <div className="container mx-auto px-4 relative z-10">
        <div className="md:ml-[30%]">
          ...
          <h1 className="text-5xl md:text-7xl font-display leading-[0.95] tracking-tight">
            Sickle Cell<br />
            <span className="italic text-primary">Empowerment</span><br />
            & Care Link
          </h1>
        ...
        <div className="grid md:grid-cols-2 gap-16 max-w-5xl mx-auto">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-display leading-tight">
              Hadiza<br /><span className="italic text-primary">Haruna</span>
            </h2>
            <div className="w-12 h-[2px] bg-advocacy-red mt-6" />
          </div>
          <div className="space-y-6">
            ...
            <p className="text-foreground leading-relaxed text-lg font-medium italic font-display text-xl">
    ...
    <section className="py-24 md:py-32">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-display leading-tight">
            Why We <span className="italic text-primary">Started</span>
          </h2>
        </div>
        ...
        <div className="mt-16 text-center">
          <Link to="/services" className="group inline-flex items-center gap-2 text-sm uppercase tracking-widest text-primary hover:text-primary/80 transition-colors"
            style={{ fontFamily: "'Poppins', sans-serif" }}>
