...
const Community = () => (
  <div>
    {/* Hero */}
    <section className="relative min-h-[70vh] flex items-center bg-advocacy-red overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_30%,hsl(var(--empowerment-purple)/0.3),transparent_50%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,hsl(0_0%_0%/0.15),transparent_50%)]" />
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-display leading-tight">
            Why Join <span className="italic text-advocacy-red">SECLUSA</span>?
          </h2>
        </div>

        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-0 border-t-2 border-advocacy-red border-l border-border max-w-5xl mx-auto">
          {benefits.map((b) => (
            <div key={b.title} className="border-b border-r border-border p-8 hover:bg-advocacy-red/5 transition-colors">
              <b.icon className="w-6 h-6 text-advocacy-red mb-5" />
    ...
    <section className="bg-card py-24 md:py-32">
      <div className="container mx-auto px-4 max-w-3xl text-center">
        <h2 className="text-4xl md:text-5xl font-display mb-6">
          Get <span className="italic text-advocacy-red">Involved</span>
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a href="https://wa.me/2349068963469" target="_blank" rel="noreferrer">
            <Button variant="outline" className="rounded-none px-8 py-6 uppercase text-xs tracking-widest border-advocacy-red text-advocacy-red hover:bg-advocacy-red/5"
              style={{ fontFamily: "'Poppins', sans-serif" }}>
