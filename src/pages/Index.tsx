...
const Index = () => {
  ...
  return (
    <div>
      ...
      {/* ═══════ STATS ═══════ */}
      <section className="bg-advocacy-red text-primary-foreground py-12 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-1/3 h-full bg-empowerment-purple/20 blur-3xl pointer-events-none" />
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <Section delay={0.2}>
              <div>
                ...
                <p className="text-foreground leading-relaxed text-lg font-medium border-l-4 border-empowerment-purple pl-6">
                  "{content.about.quote}"
                </p>
                <div className="w-16 h-[3px] bg-gradient-to-r from-advocacy-red to-empowerment-purple mt-8" />
              </div>
            </Section>
          </div>
        </div>
      ...
      <section className="bg-card py-24 md:py-32 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-2 h-full bg-gradient-to-b from-empowerment-purple to-advocacy-red hidden md:block" />
      ...
      <Section>
        <div className="relative h-[50vh] overflow-hidden group">
          <img
            ...
            loading="lazy"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-advocacy-red/30 via-advocacy-red/25 to-empowerment-purple/30" />
          ...
          {content.testimonials.map((t, i) => (
            <Section key={i} delay={i * 0.2}>
              <div className={`py-16 ${i < content.testimonials.length - 1 ? "border-b border-border" : ""}`}>
                ...
                <div className="mt-8 w-16 h-[3px] bg-gradient-to-r from-advocacy-red to-empowerment-purple md:ml-20" />
              </div>
            </Section>
          ))}
        </div>
                ...
                <div className="space-y-8">
                  {[
                    ...
                    <div key={c.title} className="flex items-start gap-5">
                      <div className="w-12 h-12 bg-empowerment-purple/10 flex items-center justify-center shrink-0">
                        <c.icon className="w-5 h-5 text-empowerment-purple" />
                      </div>
                      <div>
                ...
                <div className="mt-12 pt-8 border-t border-border">
                  ...
                  <div className="flex gap-3">
                    <a href="https://www.instagram.com/khady_bakes_and_sweets_venture" target="_blank" rel="noreferrer"
                      className="w-12 h-12 border border-empowerment-purple/20 flex items-center justify-center hover:bg-empowerment-purple/10 hover:border-empowerment-purple transition-colors">
