...
const Footer = () => (
  <footer className="bg-foreground text-background">
    <div className="w-full h-[4px] bg-gradient-to-r from-advocacy-red via-empowerment-purple to-advocacy-red" />
    <div className="container mx-auto px-4 py-16">
        ...
        <div>
          ...
          <div className="flex gap-4 mt-6">
            <a href="https://www.instagram.com/khady_bakes_and_sweets_venture" target="_blank" rel="noreferrer"
              className="w-10 h-10 border border-background/20 flex items-center justify-center hover:bg-empowerment-purple hover:border-empowerment-purple transition-colors">
      ...
      <div className="border-t border-background/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-xs opacity-40">
        <span>© {new Date().getFullYear()} SECLUSA. All rights reserved.</span>
        <span className="mt-2 md:mt-0">Empowering Lives Affected by Sickle Cell</span>
      </div>
    </div>
  </footer>
);
