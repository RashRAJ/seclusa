  ...
  <footer className="bg-foreground text-background">
    <div className="container mx-auto px-4 py-16">
      <div className="grid md:grid-cols-4 gap-10">
        ...
        {/* Quick Links */}
        <div>
          <h4 className="text-xs uppercase tracking-widest opacity-40 mb-5" style={{ fontFamily: "'Poppins', sans-serif" }}>
            Navigation
          </h4>
          <div className="space-y-3 text-sm">
            {[
              ...
              <Link key={item.path} to={item.path} className="block opacity-60 hover:opacity-100 transition-opacity">
                {item.label}
              </Link>
            ))}
          </div>
